...
### MacOS build
```
git clone https://github.com/Spare-Network/spare-blockchain --recurse-submodules
cd spare-blockchain
...
git clone https://github.com/Spare-Network/spare-blockchain.git --recurse-submodules
cd spare-blockchain
...
git clone https://github.com/Spare-Network/shia-blockchain.git --recurse-submodules
cd spare-blockchain
